...
object PlanningPreferenceCodec {
    ...
    fun read(values: Preferences): PlanningConfig = runCatching {
        ...
        PlanningConfig((values[key("capacity")] ?: defaults.dailyStudyCapacityMinutes).let { if (it in 271..600) 270 else it },
            ...
            (values[key("transition")] ?: defaults.postSchoolRecoveryMinutes).let { if (it in 30..44) 45 else it })
