package com.example.mydailyroutine.features.examples.data
...
class DemoDataSeeder(
    ...
    private val subjectColors: List<Long>,
        ...
        db.withTransaction {
            ...
            suspend fun subject(@StringRes name: Int, colorIndex: Int, duration: Int): Long = db.subjects().insert(
                SubjectEntity(name = context.getString(R.string.demo_prefix, context.getString(name)),
                    colorHex = subjectColors[colorIndex], defaultDurationMinutes = duration),
            )
            ...
            fun block(subjectId: Long?, @StringRes title: Int, category: RoutineCategory,
                day: DayOfWeek, start: LocalTime, end: LocalTime) = TimeBlockEntity(
                subjectId = subjectId, title = context.getString(R.string.demo_prefix, context.getString(title)),
                category = category, dayOfWeek = day, startMinutes = start.toSecondOfDay() / 60, durationMinutes = com.example.mydailyroutine.domain.model.nominalMinutes(start, end),
                isFixedCommitment = category == RoutineCategory.SCHOOL || category == RoutineCategory.ADMIN,
                elasticity = if (category == RoutineCategory.SCHOOL || category == RoutineCategory.ADMIN) 0.0 else 1.0,
            ...
            fun milestone(subjectId: Long?, @StringRes title: Int, dueDate: LocalDate,
                ...
                targetDeadlineEpochDay = dueDate.toEpochDay(), dueTime = dueTime, isExam = isExam,
            )
            val blocks = buildList {
                // ---------- MONDAY ----------
                add(block(null, R.string.demo_wake, RoutineCategory.ADMIN, DayOfWeek.MONDAY, t(6, 45), t(7, 30)))
                ...
                add(block(null, R.string.demo_morning_break, RoutineCategory.REST_BUFFER, DayOfWeek.MONDAY, t(10, 50), t(11, 20)))
                add(block(physicsId, R.string.demo_physics, RoutineCategory.SCHOOL, DayOfWeek.MONDAY, t(11, 20), t(12, 50)))
                add(block(null, R.string.demo_lunch, RoutineCategory.REST_BUFFER, DayOfWeek.MONDAY, t(12, 50), t(13, 40)))
                add(block(historyId, R.string.demo_history, RoutineCategory.SCHOOL, DayOfWeek.MONDAY, t(13, 40), t(14, 25)))
                add(block(mathId, R.string.demo_math_problem_sets, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.MONDAY, t(15, 15), t(16, 45)))
                add(block(null, R.string.demo_walk_reset, RoutineCategory.REST_BUFFER, DayOfWeek.MONDAY, t(16, 45), t(17, 15)))
                add(block(physicsId, R.string.demo_physics_analysis, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.MONDAY, t(17, 15), t(18, 45)))
                add(block(null, R.string.demo_gym, RoutineCategory.ADMIN, DayOfWeek.MONDAY, t(19, 30), t(20, 30)))

                // ---------- TUESDAY ----------
                add(block(null, R.string.demo_wake, RoutineCategory.ADMIN, DayOfWeek.TUESDAY, t(6, 45), t(7, 30)))
                ...
                add(block(null, R.string.demo_morning_break, RoutineCategory.REST_BUFFER, DayOfWeek.TUESDAY, t(10, 50), t(11, 20)))
                add(block(mathId, R.string.demo_math, RoutineCategory.SCHOOL, DayOfWeek.TUESDAY, t(11, 20), t(12, 50)))
                add(block(null, R.string.demo_lunch, RoutineCategory.REST_BUFFER, DayOfWeek.TUESDAY, t(12, 50), t(13, 40)))
                add(block(casId, R.string.demo_tok_lesson, RoutineCategory.SCHOOL, DayOfWeek.TUESDAY, t(13, 40), t(14, 25)))
                add(block(englishId, R.string.demo_english_draft, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.TUESDAY, t(14, 40), t(16, 10)))
                add(block(null, R.string.demo_walk_snack, RoutineCategory.REST_BUFFER, DayOfWeek.TUESDAY, t(16, 10), t(16, 40)))
                add(block(historyId, R.string.demo_history_reading, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.TUESDAY, t(16, 40), t(18, 0)))
                add(block(null, R.string.demo_free_time, RoutineCategory.ADMIN, DayOfWeek.TUESDAY, t(20, 0), t(22, 0)))

                // ---------- WEDNESDAY ----------
                add(block(null, R.string.demo_wake, RoutineCategory.ADMIN, DayOfWeek.WEDNESDAY, t(6, 45), t(7, 30)))
                ...
                add(block(null, R.string.demo_morning_break, RoutineCategory.REST_BUFFER, DayOfWeek.WEDNESDAY, t(10, 50), t(11, 20)))
                add(block(physicsId, R.string.demo_physics, RoutineCategory.SCHOOL, DayOfWeek.WEDNESDAY, t(11, 20), t(12, 50)))
                add(block(null, R.string.demo_lunch, RoutineCategory.REST_BUFFER, DayOfWeek.WEDNESDAY, t(12, 50), t(13, 40)))
                add(block(germanId, R.string.demo_german, RoutineCategory.SCHOOL, DayOfWeek.WEDNESDAY, t(13, 40), t(14, 25)))
                add(block(mathId, R.string.demo_math_revision, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.WEDNESDAY, t(15, 0), t(16, 30)))
                add(block(null, R.string.demo_cas_sport, RoutineCategory.ADMIN, DayOfWeek.WEDNESDAY, t(17, 0), t(18, 30)))
                add(block(germanId, R.string.demo_german_vocabulary, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.WEDNESDAY, t(19, 0), t(20, 0)))

                // ---------- THURSDAY ----------
                add(block(null, R.string.demo_wake, RoutineCategory.ADMIN, DayOfWeek.THURSDAY, t(6, 45), t(7, 30)))
                ...
                add(block(null, R.string.demo_morning_break, RoutineCategory.REST_BUFFER, DayOfWeek.THURSDAY, t(10, 50), t(11, 20)))
                add(block(englishId, R.string.demo_english, RoutineCategory.SCHOOL, DayOfWeek.THURSDAY, t(11, 20), t(12, 50)))
                add(block(null, R.string.demo_lunch, RoutineCategory.REST_BUFFER, DayOfWeek.THURSDAY, t(12, 50), t(13, 40)))
                add(block(casId, R.string.demo_cas_project, RoutineCategory.FOCUS_SYNTHESIZING, DayOfWeek.THURSDAY, t(13, 40), t(15, 10)))
                add(block(physicsId, R.string.demo_physics_focus, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.THURSDAY, t(15, 30), t(17, 0)))
                add(block(null, R.string.demo_dinner_rest, RoutineCategory.REST_BUFFER, DayOfWeek.THURSDAY, t(17, 0), t(18, 30)))
                add(block(historyId, R.string.demo_history_draft, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.THURSDAY, t(18, 30), t(20, 0)))

                // ---------- FRIDAY ----------
                add(block(null, R.string.demo_wake, RoutineCategory.ADMIN, DayOfWeek.FRIDAY, t(6, 45), t(7, 30)))
                ...
                add(block(null, R.string.demo_morning_break, RoutineCategory.REST_BUFFER, DayOfWeek.FRIDAY, t(10, 50), t(11, 20)))
                add(block(mathId, R.string.demo_math, RoutineCategory.SCHOOL, DayOfWeek.FRIDAY, t(11, 20), t(12, 50)))
                add(block(null, R.string.demo_lunch, RoutineCategory.REST_BUFFER, DayOfWeek.FRIDAY, t(12, 50), t(13, 40)))
                add(block(physicsId, R.string.demo_physics_lab, RoutineCategory.SCHOOL, DayOfWeek.FRIDAY, t(13, 40), t(15, 10)))
                add(block(null, R.string.demo_wind_down, RoutineCategory.REST_BUFFER, DayOfWeek.FRIDAY, t(15, 10), t(17, 0)))
                add(block(null, R.string.demo_friends, RoutineCategory.ADMIN, DayOfWeek.FRIDAY, t(18, 0), t(23, 0)))

                // ---------- SATURDAY ----------
                add(block(null, R.string.demo_sleep_breakfast, RoutineCategory.ADMIN, DayOfWeek.SATURDAY, t(8, 30), t(10, 0)))
                add(block(mathId, R.string.demo_math_weekly_review, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.SATURDAY, t(10, 15), t(11, 45)))
                add(block(null, R.string.demo_walk_outside, RoutineCategory.REST_BUFFER, DayOfWeek.SATURDAY, t(11, 45), t(12, 30)))
                add(block(englishId, R.string.demo_ee_project, RoutineCategory.FOCUS_SYNTHESIZING, DayOfWeek.SATURDAY, t(13, 0), t(15, 0)))
                add(block(null, R.string.demo_sport, RoutineCategory.ADMIN, DayOfWeek.SATURDAY, t(16, 0), t(17, 30)))
                add(block(null, R.string.demo_social, RoutineCategory.ADMIN, DayOfWeek.SATURDAY, t(19, 0), t(23, 30)))

                // ---------- SUNDAY ----------
                add(block(null, R.string.demo_sleep_in, RoutineCategory.ADMIN, DayOfWeek.SUNDAY, t(9, 0), t(10, 30)))
                add(block(physicsId, R.string.demo_physics_notes, RoutineCategory.FOCUS_ANALYTICAL, DayOfWeek.SUNDAY, t(11, 0), t(12, 30)))
                add(block(null, R.string.demo_lunch_family, RoutineCategory.REST_BUFFER, DayOfWeek.SUNDAY, t(12, 30), t(14, 0)))
                add(block(casId, R.string.demo_week_planning, RoutineCategory.FOCUS_SYNTHESIZING, DayOfWeek.SUNDAY, t(14, 30), t(15, 30)))
                add(block(null, R.string.demo_recharge, RoutineCategory.REST_BUFFER, DayOfWeek.SUNDAY, t(15, 30), t(21, 0)))
                add(block(null, R.string.demo_sleep, RoutineCategory.ADMIN, DayOfWeek.SUNDAY, t(22, 30), t(6, 45)))
            }
