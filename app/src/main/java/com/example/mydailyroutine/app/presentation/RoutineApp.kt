                        ...
                        BoxWithConstraints(
                            ...
                            Box(
                                Modifier.width(cell).fillMaxHeight()
                                    ...
                                    .background(RoutineColors.SurfaceHigh, RoutineShapes.Pill)
                                    .border(1.dp, RoutineColors.Primary.copy(alpha = 0.20f), RoutineShapes.Pill),
                            )
                                ...
                                TimelineMode.entries.forEach { mode ->
                                    ...
                                    Box(
                                        ...
                                        RoutineLabel(
                                            ...
                                            color = if (selected) RoutineColors.Primary else RoutineColors.TextSecondary,
                                        )
                                    }
                                }
                            }
