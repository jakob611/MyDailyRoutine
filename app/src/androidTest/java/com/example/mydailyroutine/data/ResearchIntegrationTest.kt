...
class ResearchIntegrationTest {
    ...
    @Test fun versionThreeBacklogMigratesWithOriginalEstimate(): Unit = runBlocking(kotlinx.coroutines.Dispatchers.IO) {
        ...
        try {
            ...
            val migrated=Room.databaseBuilder(context,RoutineDatabase::class.java,name).addMigrations(DatabaseMigrations.MIGRATION_3_4, DatabaseMigrations.MIGRATION_4_5, DatabaseMigrations.MIGRATION_5_6)
