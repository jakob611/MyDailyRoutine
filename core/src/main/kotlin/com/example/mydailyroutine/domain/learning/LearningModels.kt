...
data class ReviewDayCapacity(val epochDay: Long, val studyCapacityMinutes: Int, val studyMinutes: Int,
    val reviewMinutes: Int, val freeMinutes: Int)
...
data class ReviewAllocation(val ordinal: Int, val idealEpochDay: Long, val scheduledEpochDay: Long?, val durationMinutes: Int, val jitterRadiusDays: Int)
